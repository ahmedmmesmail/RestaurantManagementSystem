...
public class Customer {
    ...
    public void showWindow() {
        if (customerStage != null && customerStage.isShowing()) {
            customerStage.setIconified(false);
        ...
        customerStage.getIcons().add(new Image(getClass().getResourceAsStream("/images/icon.png")));
        ...
        close.setOnAction(e -> customerStage.close());
